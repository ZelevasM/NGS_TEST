...
object ListsTable
{
    ...
    const val LISTS_COLUMN_NAME_ORDER: String = "Lists_Order"
    const val LISTS_COLUMN_NAME_COLOR: String = "Color"
    //<- LIST BASIC TABLE
    ...
    const val CREATE_TABLE = "CREATE TABLE IF NOT EXISTS $LISTS_TABLE_NAME" +
            ...
            "$LISTS_COLUMN_NAME_DATE TEXT,$LISTS_COLUMN_NAME_ORDER INTEGER, $LISTS_COLUMN_NAME_COLOR TEXT)"
